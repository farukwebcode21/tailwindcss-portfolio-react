            ...
            <section className='w-full'>
                ...
                <div className='w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24'>
                    <div className='space-y-12'>
                        <div>
                            <label className='block mb-6 text-xl font-bold'>Name</label>
                            <input className="w-full border border-input-border bg-input px-4 py-4"></input>
                        </div>
                        <div>
							<label className="text-white block mb-6 text-xl font-bold">Email</label>
							<input type="email" className="w-full border border-input-border bg-input px-4 py-4"></input>
                        </div>
                        <div>
                    ...
                    <div className="mt-12">
						...
						<a href="mailto:farukahmad@yahoo.com" className="text-secondary underline mt-3 block">farukahmad@yahoo.com</a>
